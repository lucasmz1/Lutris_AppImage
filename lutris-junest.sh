...
_post_installation_processes() {
	...
	cp -f AppRun ./AppDir/
	cd AppDir/.junest/usr/share/vulkan/icd.d/ && ls | xargs -I {} sh -c 'ln -rs "{}" "$(echo {} | sed "s/\.json$/\.x86_64\.json/")"'
	cd ${GITHUB_WORKSPACE}
}
