...
BINSAVED="sha256sum cblas glew glfw python-contourpy python-cycler python-dateutil python-fonttools python-kiwisolver python-matplotlib python-numpy python-pyparsing python-six qhull mangoapp 7z 7za 7zr fc-cache fc-cat fc-conflist fc-list fc-match fc-pattern fc-query fc-scan fc-validate goverlay dbus dbus-daemon dbus-launch dbus-monitor dbus-run-session dbus-send dbus-test-tool dbus-update-activation-environment dbus-uuidgen dbus-broker dbus-broker-launch loadericdscan ldconfig gamescope mangohud mangohudctl mangoplot tar lsblk gzip od zenity free hugetop pgrep pidof pidwait pkill pmap ps pwdx slabtop sysctl tload top uptime vmstat w watch taskset vkcube vkcubepp vulkaninfo cabextract curl p7zip unzip eglgears_wayland eglgears_x11 eglinfo eglkms egltri_wayland egltri_x11 es2_info es2gears_wayland es2gears_x11 es2tri glxgears glxinfo peglgears vkgears xeglgears xeglthreads"
SHARESAVED="vulkan"
