...
SHARESAVED="vulkan"
LIBSAVED="libadwaita libgl lib32-libgl vulkan-icd-loader lib32-vulkan-icd-loader gnutls lib32-gnutls alsa jack pipewire pulse gdk-pixbuf svg HarfBuzz harfbuzz Atk idna girepository zstd Zstd mesa vulkan-nouveau mesa-libgl vulkan-swrast vulkan-asahi vulkan-mesa-layers vulkan-virtio-gpu lib32-mesa lib32-nvidia-utils vulkan-icd-loader lib32-vulkan-icd-loader gnutls lib32-gnutls"
