...
DEPENDENCES=$(echo "zenity dbus dbus-broker dbus-x11 gamescope mangohud dbus-broker-units dbus-units vulkan-icd-loader lib32-vulkan-icd-loader vulkan-radeon lib32-vulkan-radeon vulkan-intel lib32-vulkan-intel nvidia-utils lib32-nvidia-utils vulkan-nouveau lib32-vulkan-nouveau vulkan-swrast lib32-vulkan-swrast vulkan-validation-layers lib32-vulkan-validation-layers vulkan-utility-libraries lib32-vulkan-utility-libraries vulkan-mesa-layers lib32-vulkan-mesa-layers lib32-vulkan-icd-loader lib32-mangohud sdl2 util-linux tar gzip coreutils python-charset-normalizer util-linux vulkan-intel lib32-vulkan-intel vulkan-radeon lib32-vulkan-radeon 7zip freetype2 lib32-freetype2 file gtk-update-icon-cache pciutils harfbuzz xterm adwaita-icon-theme adwaita-icon-theme-legacy lib32-libglvnd vulkan-icd-loader lib32-vulkan-icd-loader lib32-gnutls cabextract curl gdk-pixbuf2 glib2 gnome-desktop gobject-introspection-runtime gtk3 hicolor-icon-theme mesa-utils p7zip pango psmisc python python-cairo python-certifi python-dbus python-distro python-evdev python-gobject python-lxml python-moddb python-pillow python-requests python-urllib3 python-yaml unzip webkit2gtk-4.1 xdg-desktop-portal-impl xorg-xrandr fluidsynth gamemode gvfs innoextract lib32-gamemode lib32-gnutls lib32-mesa-libgl lib32-vkd3d libayatana-appindicator python-pefile python-protobuf umu-launcher vkd3 vulkan-tools xorg-xgamma git meson ninja protobuf python-poetry-core fluidsynth pciutils python-nose vulkan-tools xorg-server-xvfb xterm" | tr ' ' '\n' | sort -u | xargs)
...
BINSAVED="sha256sum mangoapp dbus dbus-daemon dbus-launch dbus-monitor dbus-run-session dbus-send dbus-test-tool dbus-update-activation-environment dbus-uuidgen dbus-broker dbus-broker-launch loadericdscan ldconfig gamescope mangohud mangohudctl mangoplot tar lsblk gzip od zenity free hugetop pgrep pidof pidwait pkill pmap ps pwdx slabtop sysctl tload top uptime vmstat w watch taskset vkcube vkcubepp vulkaninfo cabextract curl p7zip unzip eglgears_wayland eglgears_x11 eglinfo eglkms egltri_wayland egltri_x11 es2_info es2gears_wayland es2gears_x11 es2tri glxgears glxinfo peglgears vkgears xeglgears xeglthreads"
SHARESAVED="vulkan"
LIBSAVED="libadwaita libvklayer mangohud vulkan-icd-loader vulkan-validation-layers vulkan-utility-libraries vulkan-mesa-layers libvulkan libmangohud lib32-mangohud vulkan-intel vulkan-radeon libsdl2 libgl lib32-libgl vulkan-icd-loader gnutls lib32-gnutls alsa jack pipewire pulse gdk-pixbuf svg HarfBuzz harfbuzz Atk idna girepository zstd Zstd mesa vulkan-nouveau mesa-libgl vulkan-swrast vulkan-asahi vulkan-mesa-layers vulkan-virtio-gpu vulkan-icd-loader gnutls lib32-gnutls"
