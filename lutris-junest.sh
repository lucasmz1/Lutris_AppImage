...
SHARESAVED="vulkan"
LIBSAVED="libadwaita libvklayer mangohud vulkan-icd-loader vulkan-validation-layers vulkan-utility-libraries vulkan-mesa-layers libvulkan libmangohud lib32-mangohud vulkan-intel vulkan-radeon libsdl2 libgl lib32-libgl vulkan-icd-loader lib32-vulkan-icd-loader gnutls lib32-gnutls alsa jack pipewire pulse gdk-pixbuf svg HarfBuzz harfbuzz Atk idna girepository zstd Zstd mesa vulkan-nouveau mesa-libgl vulkan-swrast vulkan-asahi vulkan-mesa-layers vulkan-virtio-gpu lib32-mesa lib32-nvidia-utils vulkan-icd-loader lib32-vulkan-icd-loader gnutls lib32-gnutls"
